...
namespace CTRPluginFramework {
    Button::Button(u32 type, const string &content, const IntRect &bounds, IconCallback icon) :
    ...
    Button::Button(u32 type, const string &content, const IntRect &bounds, IconCallbackState icon):
    ...
    void Button::Draw(void) {
        ...
        else Renderer::DrawString((char*)_content.c_str(), posX, posY, textColor);
    }
