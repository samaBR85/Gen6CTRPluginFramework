...
namespace CTRPluginFramework {
    MenuEntry::MenuEntry(const string &name, const string &note) :
        Hotkeys(this),
        _item(new MenuEntryImpl(name, note, this))
    {}

    MenuEntry::MenuEntry(const string &name, FuncPointer func, const string &note) :
        Hotkeys(this),
        _item(new MenuEntryImpl(name, func, note, this))
    {}

    MenuEntry::MenuEntry(const string &name, FuncPointer GameFunc, FuncPointer MenuFunc, const string &note) :
        Hotkeys(this),
    ...
    MenuEntry::MenuEntry(int radioId, const string &name, FuncPointer func, const string &note) :
        Hotkeys(this),
        _item(new MenuEntryImpl(name, func, note, this))
    ...
    MenuEntry::MenuEntry(int radioGroup, const string &name, FuncPointer GameFunc, FuncPointer MenuFunc, const string &note) :
        Hotkeys(this),
        _item(new MenuEntryImpl(name, GameFunc, note, this))
    ...
    string &MenuEntry::Name(void) const {
        return (_item->name);
    }
