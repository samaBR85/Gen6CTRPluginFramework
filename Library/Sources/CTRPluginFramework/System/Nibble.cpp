...
namespace CTRPluginFramework {
    bool Nibble::Read8(u32 address, u8 &value, bool rightSide) {
    ...
    bool Nibble::Read8(vector<u32> address, vector<u8> &value, vector<bool> rightSide) {
        bool out = false;
    ...
    bool Nibble::Write8(u32 address, u8 value, bool rightSide) {
        // Checks if address is valid or not
        if (!Process::CheckAddress(address))
            return false;
    ...
    bool Nibble::Write8(vector<u32> address, vector<u8> value, vector<bool> rightSide) {
        bool out = false;
