...
namespace CTRPluginFramework {
    ...
    class System {
        public:
            ...
            /**
             * \brief Check if the cfw is Luma3DS or not. A version number can be passed and if it's the case the function will return whether the version of the cfw is the same or higher (true) or inferior (false)
