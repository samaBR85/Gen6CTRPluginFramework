...
namespace CTRPluginFramework {
    class Button : public Drawable {
        ...
        public:
            ...
            Button(u32 type, const string &content, const IntRect &bounds, IconCallback icon);
            Button(u32 type, const string &content, const IntRect &bounds, IconCallbackState icon = nullptr);
