    ...
    class Keyboard {
        ...
        public:
            ...
            */
            ...
            int Setup(const string &name, bool canAbort, bool isHex, const int maxLength, u8 &output, u8 start);
            int Setup(const string &name, bool canAbort, bool isHex, const int maxLength, u16 &output, u16 start);
            int Setup(const string &name, bool canAbort, bool isHex, const int maxLength, u32 &output, u32 start);
            int Setup(const string &name, bool canAbort, const vector<string> &options, int &index);
